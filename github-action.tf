module "github_action" {
  ...
  github_repositories = ["repo:kwame-mintah/ml-data-copy-to-aws-s3:ref:refs/heads/main", "repo:kwame-mintah/aws-lambda-data-preprocessing:ref:refs/heads/main", "repo:kwame-mintah/aws-lambda-model-training:ref:refs/heads/main", "repo:kwame-mintah/aws-lambda-model-deployment:ref:refs/heads/main"]
